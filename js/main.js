...
scoreboard.help(
   ...
   function SGO() {
scoreboard.help(
    ' There are 11,000  Days measured in earth time.' +
   ...
   function UGO() {
scoreboard.help(
    ' There are 31,000 Days measured in earth time in a year.' +
...
scoreboard.help(
 ...
 var scoreboard = new Scoreboard();
  scoreboard.help(
    ' Press E or click the button to veiw from earth.' +
    ' Press A or click the button to veiw from above.' +
